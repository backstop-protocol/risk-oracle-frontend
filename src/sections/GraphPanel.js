...
const MainPanel = observer(props => {
  ...
  return (
      <Box sx={{flex:"0 2 auto", marginTop:"5%", width:"100%", height:"100%", display:'flex', flexDirection:"column", justifyContent:"space-evenly", alignItems:"center", height:"100%", rowGap:"7%"}}>
