...
const First = props => {
  ...
  return <div className="container-fluid" style={{marginTop: '102px'}}>
    <section  style={styles.flex}>
      ...
      <Fab sx={{position:"absolute", marginLeft:"auto", width:"7vw", marginRight:"auto", left:"0", right:"0", bottom:"0", zIndex:"10", color:"secondary.main"}} variant="extended" onClick={(e)=>{goTo(e,'mainSection')}}>
